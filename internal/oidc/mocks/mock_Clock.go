...
func (_mock *Clock) Now() oidc.Instant {
	ret := _mock.Called()
	...
	var r0 oidc.Instant
	if returnFunc, ok := ret.Get(0).(func() oidc.Instant); ok {
		r0 = returnFunc()
	} else {
		r0 = ret.Get(0).(oidc.Instant)
	}
	return r0
}
...
func (_c *Clock_Now_Call) Return(instant oidc.Instant) *Clock_Now_Call {
	_c.Call.Return(instant)
	return _c
}

func (_c *Clock_Now_Call) RunAndReturn(run func() oidc.Instant) *Clock_Now_Call {
	_c.Call.Return(run)
	return _c
}
